...
t_ext = 37  # время, через которое выпускается новый бонус ЖИЗНЬ. можно редактировать
n_ext = 1  # количество бонусов ЖИЗНЬ, сгенерированных за игру
t_vpn = 11  # время, через которое выпускается новый бонус VPN. можно редактировать
